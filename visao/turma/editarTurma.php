...
<body>
    ...
    <div class="container">
        <div class="row" style="margin-top: 3%">
            <div class="col-md-12">
                <h4>Editar Turma </h4>
                <form method="POST" action="/devWeb2021_03/repositorio/turma/editarTurma.php">
                    <?php
                    try {
                    ...
                    try {
                        if ($_POST) {
                            if (!empty($_POST['idTurma'])) {
                                $sql = "SELECT * FROM turma where \"idTurma\" = '" . $_POST['idTurma'] . "'";
                            }
                        } else {
                            echo "<script>alert('Não foi possível encontrar a Turma!');</script>";
                            header("refresh:0;url=/devWeb2021_03/visao/turma/buscarTurma.php");
                        }
                    ...
                    ?>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="number" value="<?php echo $row['numero']; ?>" id="NumeroID" class="form-control" name="numero" placeholder="Número">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="dataInicioID"> Data Início </label>
                                <input type="date" value="<?php echo $row['dataInicio']; ?>" id="dataInicioID" class="form-control" name="dataInicio" placeholder="Data Início">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="listadeAlunosID"> Lista de Alunos </label>
                                <select name="listaAlunos" id="listadeAlunosID" class="form-control">
